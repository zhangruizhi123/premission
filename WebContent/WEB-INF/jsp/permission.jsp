...
function remove(){
	...
	var id=row.id;
	$.ajax({
		url:'${ctx}/admin/permission/delete?id='+id,
		type:'get',
...
<body>
		...
		<table id="tt" class="easyui-datagrid" style="width:100%;"
			...
			<thead>
				...
				<tr>
					...
					<th field="name" width="200" align="center">权限名称</th>
					<th field="description" width="200" align="center">权限描述</th>
				</tr>
			</thead>
		</table>
		<div id="tb">
	...
	<div id="winAdd" closed="true" class="easyui-dialog" style="padding:10px;width:600px;height:400px;"
		...
		<form id="fmtt" method="post" action="">
			...
			<div class="padding5">
				<label>权限名称: </label><input id="name" name="name" type="text" style="width:180px;" required="true"  class="easyui-validatebox">
			</div>
			<div class="padding5">
				<div>权限描述</div>
