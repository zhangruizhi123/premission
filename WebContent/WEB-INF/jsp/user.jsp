...
function remove(){
	...
	var id=row.id;
	$.ajax({
		url:'${ctx}/admin/user/delete?id='+id,
		type:'get',
...
<body>
		...
		<table id="tt" class="easyui-datagrid" style="width:100%;"
			...
			<thead>
				<tr>
					...
					<th field="createDate" width="200" align="center" formatter="dateTimeFormat">创建日期</th>
				</tr>
			</thead>
		</table>
		<div id="tb">
	...
	<div id="winAdd" closed="true" class="easyui-dialog" style="padding:10px;width:600px;height:400px;"
		...
		<form id="fmtt" method="post" action="">
			...
			<div class="padding5">
				<label>用户名称: </label><input id="name" name="name" type="text" style="width:180px;" required="true"  class="easyui-validatebox">
			</div>
			
			<div class="padding5">
				<label>密码: </label><input id="password"  name="password" type="password" style="width:180px;" required="true"  class="easyui-validatebox">
			</div>
			
			<div class="padding5">
				<label>确认码: </label><input id="repassword" name="repassword" type="password" style="width:180px;" required="true"  class="easyui-validatebox">
			</div>
		</form>
		<div>角色选择:</div>
		<div id="select">
